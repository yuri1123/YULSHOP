...
//        }
    ...
    public void addOrderTotalIncome(int orderTotalIncome){
        this.orderTotalIncome += orderTotalIncome;
    }
    public void removeOrderTotalIncome(int orderTotalIncome){
        int nowOrderTotalIncome = this.orderTotalIncome - orderTotalIncome;
        this.orderTotalIncome = nowOrderTotalIncome;
    }
}
